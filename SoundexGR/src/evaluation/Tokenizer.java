...
public class Tokenizer {
     ...
     * @return ArrayList<String> with the tokens (words)
     **/
    ...
    /**
     * It returns an ArrayList with the lines  of a string (textual paragraphs)
     *
     * @param s the input string
     * @return ArrayList<String> with the lines
     **/
